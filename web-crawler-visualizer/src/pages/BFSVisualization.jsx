...
const RealTimeBFSVisualization = () => {
  ...
  useEffect(() => {
    const ws = new WebSocket(`{import.meta.env.VITE_BASE_URL}/ws/bfs-crawl`);
    wsRef.current = ws;
  ...
  return (
    <div className="min-h-screen bg-gray-200 flex flex-col items-center p-4">
      <h1 className="text-3xl font-bold text-gray-800 mb-8">Real-Time BFS Crawl</h1>
      <div
...
export default RealTimeBFSVisualization;
